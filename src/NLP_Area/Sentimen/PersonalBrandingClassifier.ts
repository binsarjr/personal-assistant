...
class PersonalBrandingClassifierClass {
  private isLoaded = false
  classifier = new natural.BayesClassifier(natural.StemmerId)
  constructor(
    private trainpath = rootPath('database/personalbranding'),
    private dataset = rootPath('dataset/personalbranding.csv'),
  ) {
...
const PersonalBrandingClassifier = new PersonalBrandingClassifierClass()
...
export default PersonalBrandingClassifier
