...
/**
    ...
    return: null
   */
export const setUseChars = function (newchars: string) {
...
/**
   ...
   */
export const encodeText = function (text1: string, text2: string) {
...
/**
    ...
    return: unicode stego text
   */
export const encodeBinary = function (text: string, data: any) {
  return combine_shuffle_string(
    text,
...
/**
   ...
   */
export const decodeText = function (text: string) {
  let splitted = split_zerowidth_characters(text)
...
/**
   ...
   */
export const decodeBinary = function (text: string) {
  let splitted = split_zerowidth_characters(text)
...
/**
    Internal Functions
  */
let encode_to_zerowidth_characters_text = function (str1: string) {
  ...
  //let base = '0'.repeat(codelength); // IE not support this method
...
let encode_to_zerowidth_characters_binary = function (u8ary: any) {
...
let combine_shuffle_string = function (
  str1: string,
  str2: string,
  codelength: number,
) {
...
let split_zerowidth_characters = function (str1: string) {
  let result = {
...
let decode_from_zero_width_characters_text = function (str1: string) {
  let r = str1
  let i: number
  let result = []
  for (i = 0; i < radix; i++) {
  ...
  for (i = 0; i < r.length; i += codelengthText) {
    result.push(
      String.fromCharCode(parseInt(r.substr(i, codelengthText), radix)),
    )
  }

  return result.join('')
}
let decode_from_zero_width_characters_binary = function (str1: string) {
  let r = str1
  let i: number
  let j
